...
class SiteConf:
    ...
    _RSS_SITE_GRAP_CONF = {
        ...
        'hhanclub.top': {
            'FREE': ["//a[@class='index']/../div[@class='whitespace-nowrap']/b/font[@class='free']"],
            '2XFREE': [],
            'HR': ["//a[@class='index']/../span[contains(text(),'H&R')]"],
        ...
        'skyeysnow.com': {
            'FREE': ["//div[@class='pi']/b[contains(text(),'FREE')]"],
            '2XFREE': [],
            'HR': [],
            'PEER_COUNT': []
        },
    ...
    def init_config(self):
        self._RSS_SITE_GRAP_CONF = self._RSS_SITE_GRAP_CONF
        '''
        site_replacements = {
